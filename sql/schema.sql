...
CREATE TABLE useracc(
    ...
    email varchar(100), password varchar(255), NIC varchar(12), 
...
CREATE TABLE staff(
    user_id int(15) unsigned PRIMARY KEY, 
    employee_id varchar(15), role varchar(15), 
...
CREATE TABLE adminacc(
    user_id int(15) unsigned PRIMARY KEY, 
    admin_id varchar(15), FOREIGN KEY(user_id) references useracc(user_id));
